...
/* clang-format off */
#if 1 /*Standalone chat simulator configuration*/
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'A'      /*Local files are addressed as A:/absolute/path*/
...
#define LV_USE_SDL              1
    ...
    #define LV_SDL_ACCELERATED      0    /*Software rendering for WSLg*/
